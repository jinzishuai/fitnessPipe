...
void main() {
  group('SingleSquatCounter', () {
    ...
    test('transitions from waiting to standing after holding straight', () async {
      ...
      // Process frames for 300ms
       for (int i = 0; i < 4; i++) {
        fastCounter.processPose(straightPose.copyWith(
          ...
          int repCount = 0;
           ...
           for (var frame in frames) {
              ...
              if (event is RepCompleted) {
                  ...
                  print('Rep completed at ${frame.timestamp}, duration: ${event.repDuration}');
               }
           }
